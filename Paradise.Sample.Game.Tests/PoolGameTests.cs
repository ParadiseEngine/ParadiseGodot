...
public class PoolGameTests
{
    ...
    public async Task rewind_restore_reclaims_unpinned_snapshots_when_the_pool_is_starved()
    {
        ...
        // source-generated alias private to the Paradise.Sample.Game assembly — drive the stack
    ...
    private sealed class RecordingUi : Paradise.Sample.Game.Ui.IUiInput
    {
        public readonly List<Paradise.Sample.Game.Ui.UiEvent> Handled = new();
        public readonly List<double> Ticks = new();
        public bool Handle(in Paradise.Sample.Game.Ui.UiEvent uiEvent) { Handled.Add(uiEvent); return false; }
